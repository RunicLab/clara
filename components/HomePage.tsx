...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen max-h-screen overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="h-screen flex flex-col p-4 max-w-full">
        {/* Header */}
